...
Vast majority of code for this App generated by Chat-gpt 5.6 under guidance of myself.

# Textbook Tutor

Textbook Tutor is a tutoring app that turns a `.tex` mathematics instructional text into an LLM-tutor interactive concept-based learning environment where the user writes their understanding in a workspace environment while a local LLM tutor agent guides them in a socratic dialogue style.
...
## Ingesting the text and building concept cards
