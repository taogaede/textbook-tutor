...
Students primarily use AI for learning assistance in an "ask the oracle" conversation environment, which incentivizes passive learning.

So, it is better for students to use an app that incentivizes active AI-assisted learning.
...
Not thoroughly tested, but works well for my own use so far.  I think it has most of the features it needs, and most of the hard work left is in optimizing system prompts, existing features, and debugging.  Next, I intend to
